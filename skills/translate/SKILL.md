...
description: >
  ...
  artifacts for review. Run BEFORE localize: this handles language
...
content with localized keywords, meta tags, and culturally correct formatting.
...
- Next step (cultural depth): `/smart-blog-skills:localize <file> --locale <code>`
- QA sweep across all language versions: `/smart-blog-skills:locale-audit <directory>`
