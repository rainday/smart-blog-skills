...
description: >
  ...
  contraction frequency, and summary box label. Used by write and rewrite
...
blog content produced by write and rewrite.
...
## Integration with write and rewrite
...
Write and rewrite check for the active persona before generating content.
