...
也可以跳過 --full，直接 `/smart-blog:outline` 只產大綱。
...
```
/smart-blog:write "如何用 AI 優化 SEO"
/smart-blog:write "2026 年遠端工作趨勢"
```
...
```
/smart-blog:analyze ./posts/my-post.md
/smart-blog:analyze ./content/blog/seo-guide.mdx
/smart-blog:analyze ./posts/                        # 批次分析整個目錄
```
...
```
/smart-blog:rewrite ./posts/old-post.md             # 完整改寫
/smart-blog:rewrite ./posts/old-post.md --update    # 輕量更新（只更新數據和日期）
```
...
```
/smart-blog:outline "Next.js vs Astro 比較"
/smart-blog:outline "中小企業 AI 導入指南"
```
...
- 確認後可直接銜接 `/smart-blog:write` 開始寫作
